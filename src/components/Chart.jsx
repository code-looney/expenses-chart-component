                            ...
                            return (
                                <li className={`text-[10px] h-[100%] cursor-pointer `} key={index}>
                                    <div className={`flex flex-col h-[100%] gap-1 items-center justify-end w-7 md:w-9  `}>
                                        <div 
                                        className={`bg-black text-white text-[10px] font-semibold flex items-center justify-center rounded  ${hover !== index ? 'hidden ' : 'block w-11 h-8 '}`} // This is the currency
